...
import 'package:chat_app/views/Invoices_screen.dart';
  ...
  Widget build(BuildContext context) {
    return  MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context)=>InvoicesControllerCubit()),
        BlocProvider(create: (context)=>FetchInvoicesControllerCubit()),
